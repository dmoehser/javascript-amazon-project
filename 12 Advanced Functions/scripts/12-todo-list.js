...
function renderTodoList3() {
  ...
  const todoListContainer = document.querySelector('.js-todo-list-3');
  todoListContainer.innerHTML = todoListHtml;
  localStorage.setItem('todoList3', JSON.stringify(todoList3));

  // Event-Listener für die Delete-Buttons hinzufügen (Event-Delegation)
...
// Initiales Rendern der Liste
renderTodoList3();


/* My ToDo List Practice 3
// ToDo List Practice 3
const todoList3 = JSON.parse(localStorage.getItem('todoList3')) || [];
...
// Event Listener for the "Add Todo"-Buttons
document.querySelector('.js-add-todo-button1')
  .addEventListener('click', addTodo1);

  document.querySelector('.js-add-todo-button2')
  .addEventListener('click', addTodo2);

  document.querySelector('.js-add-todo-button3')
  .addEventListener('click', addTodo3);
